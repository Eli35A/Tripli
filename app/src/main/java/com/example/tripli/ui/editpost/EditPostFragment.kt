...
class EditPostFragment : Fragment() {
    ...
    private val postId: String get() = arguments?.getString(ARG_POST_ID) ?: ""
    private val existingImageUrl: String get() = arguments?.getString(ARG_IMAGE_URL) ?: ""
    ...
    private fun prefillForm() {
        ...
        val caption = arguments?.getString(ARG_CAPTION) ?: ""
        val hashtags = arguments?.getString(ARG_HASHTAGS)
